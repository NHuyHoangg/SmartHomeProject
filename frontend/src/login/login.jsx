...
function Login ( {setSignup, setLogin} ) {
    ...
    return (
        <div className="Login text-white text-center">
            <div className="login-to bg-container px-5 d-flex flex-column align-items-center col-5">
                <h1 className="text-main mt-2">
                ...
                <form className="text-text col-6">
                    <div class="mb-3">
                    ...
                    {/* <div class="alert d-flex align-items-center justify-content-center mt-4" role="alert">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div className="ms-3 py-2">
                            Username hoặc mật khẩu không chính xác
                        </div>
                    </div> */}
                    <button type="submit" class="mt-3 p-3 bg-header" onClick={()=>setLogin(true)}>Đăng nhập</button>
                    <p className="signup-link text-header mt-3 mb-5 p-3">Chưa có tài khoản?
                        <span className="ms-2">
