...
function Signup ( {setSignup} ) {
    ...
    return (
        <div className="Signup text-white text-center">
            <div className="signup-to bg-container px-5 d-flex flex-column align-items-center col-5">
                ...
                <form className="text-text row col-11 justify-content-center" onSubmit={(e) => handleSignup(e)}>
                    ...
                    <button type="submit" class="p-3 mt-3 bg-header" onClick={()=>setSignup(false)}>Đăng ký</button>
                    <p className="signup-link text-header mt-3 mb-5 p-3">Đã có tài khoản?
                        <span className="ms-2">
